...
\newacronym[category = notation-category, description= Differential equation in two or more variables]{pde}{PDE}{partial differential equation}
\newacronym[category = notation-category, description= Differential equation in one variable, usually time]{ode}{ODE}{ordinary differential equation}
\newacronym[category = notation-category, description= growth medium used for bacteria]{LB}{LB}{lysogeny broth}]
\newacronym[category = notation-category, description= measurement unit for rotation]{rpm}{rpm}{rounds per minute}]
