...
\newacronym[category = notation-category]{pde}{PDE}{partial differential equation}
\newacronym[category = notation-category]{ode}{ODE}{ordinary differential equation}
\newacronym[category = notation-category]{LB}{LB}{lysogeny broth}
\newacronym[category = notation-category]{rpm}{rpm}{rounds per minute}
\newacronym[category = notation-category]{CFU}{CFU}{colony forming units}
